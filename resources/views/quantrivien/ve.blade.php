        ...
        obj.colModel = [
            {
                ...
                render: function (ui) {
                    ...
                    str += '<a title="Delete" id="idDelTicket" ><i class="glyphicon glyphicon-remove  text-danger" style="padding-right: 5px; cursor: pointer;"></i></a>';
                    return str;
                },
                postRender: function (ui) {
                    ...
                    $cell.find("a#idDelTicket")
                        .unbind("click")
                        .bind("click", function (evt) {
                            if(confirm("Bạn chắc chắn muốn xóa?"))
                                location.assign("{{url('admin/delve')}}"+"/"+rowData["Mã"]);
                        });
                }
            },
            {
