...
@yield('content')
        ...
        <main class="main">
            ...
            <ul>
                    <li>
                        ...
                        <i>Đại Học An Giang (AGU)</i><br>
                        <i class="fa fa-phone" aria-hidden="true"></i>
                        <i>+84 296 6256565</i><br>
                        <i class="fa fa-envelope-o" aria-hidden="true"></i>
                        <i>số 18, đường Ung Văn Khiêm, phường Đông Xuyên, thành phố Long Xuyên, tỉnh An Giang</i>
                    </li>
                    <li>
                        <h4> &copy; Bản Quyền Thuộc Về Đại Học An Giang </h4>
                        <h4>&#9679; Thiết Kế Bởi: </h4>
                        <strong>Lý Ngọc Thái Bảo - DTH195128</strong><br>
                    </li>
                </ul>
            </div>
        </main>
    <!-- Kết phần footer -->
      <!-- messinger -->
  <div class="hotro">
    <a href="https://m.me/100091914370804" class="mess mb-4" > 
